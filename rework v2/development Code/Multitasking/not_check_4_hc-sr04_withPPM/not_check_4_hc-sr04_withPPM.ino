...
int distance_ultrasonic_front_left;
int distance_ultrasonic_front_right;
int distance_ultrasonic_rear_left;
int distance_ultrasonic_rear_right;
...
void setup() {
    ...
    xTaskCreatePinnedToCore(hc_sr04_task, "HC-SR04 Task", 4096, NULL, 2, NULL, 1); // Core 1
